...
_Prototype 1 - 14/12/18_
_by Conor Croasdell_

In this document the background of the design process is described, together with the instructions to assemble the kit.

In the [CAD folder](https://github.com/waagsociety/proximity_kit/tree/master/PK_MUV/Case), you will find .ai and the exported .dxf files of the case plans.

Also Solidworks .sldprt files are included, which were used to design the case para-metrically. The .sldprt format is not used outside of Solidworks.
...
A quick google search gave me some online options for designing lasercut joints. I liked [makercase.com](makercase.com) because of its  simplicity and visual preview.
...
- 4mm triplex poplar (600mm x 320mm)
...
<p align="center"><img src="images/Step 22.jpg" width="600"></p>
